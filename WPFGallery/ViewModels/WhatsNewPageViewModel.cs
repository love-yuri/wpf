...
public partial class WhatsNewPageViewModel : ObservableObject {
    ...
    [ObservableProperty] private string _accentColorXamlCode = _accentColorBrushApiXamlUsage;

    [ObservableProperty] private string _hyphenBasedLigatureXamlCode = _hyphenBasedLiagatureXamlUsage;

    [ObservableProperty] private string _pageDescription =
        "Lists all the new features, enhancements and APIs introduced in WPF for .NET 9";

    [ObservableProperty] private string _pageTitle = "What's new in WPF";
}